...
export const Card2 = ({ text, route }) => (
    
    <a onClick={() => goToRoute(route)} className="relative block p-4 overflow-hidden border bg-white border-slate-100 rounded-lg ml-6 mr-6 shadow-md mt-5" href="#">
